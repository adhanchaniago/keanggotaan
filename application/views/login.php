...
<head>
  ...
  <title>Data Keanggotaan - Login</title>
              ...
              <div class="col-lg-12">
                <div class="login-form">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900">Login DK</h1>
                    <h6 class="text-gray-900 mb-4">(Data Keanggotaan)</h6>
                  </div>
                    ...
                    <div class="form-group">
                      <div class="input-group mb-3" id="show_hide_password">
                        ...
                        <div class="input-group-append">
                          <span class="input-group-text"><a href="" style="color: #46BFE6;"><i class="fa fa-eye-slash" aria-hidden="true"></i></a></span>
                        </div>
                      </div>
                    </div><br>
                    <!-- <div class="form-group">
  ...
  <script>
    ...
    $(document).ready(function () {
        $('#login').on('submit', function (e) {
            e.preventDefault();
            var url = window.location.protocol + '//' + window.location.host + '/dklt/';
